...
namespace MouseLibrary
{
    public class MouseHook
    {
        ...
        public bool IsMouseActive(DateTime lastClick,TimeSpan interval)
        {
            return (DateTime.Now - lastClick) < interval;
        }
        public bool IsMouseActive(int x1, int x2, int y1, int y2)
        {
            if (x1 == x2 && y1 == y2)
            {
                return false;
